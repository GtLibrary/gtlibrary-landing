            ...
            <Container>
                ...
                <div className="row team-member-area">
                    ...
                    <div className="col-md-6">
                        <div className="team-member-item" data-aos="fade-right">
                            <div className="team-member-avatar">
                                <img src="/img/jp-medium.png" width="300" alt="team member avatar"></img>
                            </div>
                    ...
                    <div className="col-md-6">
                        <div className="team-member-item" data-aos="fade-right">
                            <div className="team-member-avatar">
                                <img src="/img/kn-medium.png" width="300" alt="team member avatar"></img>
                            </div>
                    ...
                    <div className="col-md-6">
                        <div className="team-member-item" data-aos="fade-right">
                            <div className="team-member-avatar">
                                <img src="/img/lk-medium.png" width="300" alt="team member avatar"></img>
                            </div>
                    ...
                    <div className="col-md-6">
                        <div className="team-member-item" data-aos="fade-right">
                            <div className="team-member-avatar">
                                <img src="/img/cb-medium.png" width="300" alt="team member avatar"></img>
                            </div>
	            ...
	            <p className="team-title">Authors</p>
                    ...
                    <div className="col-md-6">
                        <div className="team-member-item" data-aos="fade-right">
                            <div className="team-member-avatar">
                                <img src="/img/jrr-medium.jpg" width="300" alt="team member avatar"></img>
                            </div>
                    ...
                    <div className="col-md-6">
                        <div className="team-member-item" data-aos="fade-left">
                            <div className="team-member-avatar">
                                <img src="/img/ls-medium.png" alt="team member avatar"></img>
                            </div>
